 ...
 export default class Earphones extends React.Component{
		constructor(props){
			super(props);
			this.state={
				list:store.getState().earphones,
				copy:store.getState().earphones
			}
		}
		cart=(e)=>{
				...
				<div id="holder">	
					<div id="filter" ><i class="fa fa-filter c6" aria-hidden="true"> Filter</i></div>
						...
						<div class="fil" >
							...
							<div id="filter13">
									<div class="fil_content">< input class="radio" name="radio" type="radio" value="skullcandy"/>skullcandy</div>
									<div class="fil_content">< input class="radio" name="radio" type="radio" value="sony"/>sony</div>
							</div>
						</div>
					</div>
