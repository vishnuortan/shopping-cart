 ...
 export default class Watches extends React.Component{
		constructor(props){
			super(props);
			this.state={
				list:store.getState().watches,
				copy:store.getState().watches
			}
		}
		cart=(e)=>{
				...
				<div id="holder">	
					<div id="filter" ><i class="fa fa-filter c6" aria-hidden="true"> Filter</i></div>
						...
						<div class="fil" >
							...
							<div id="filter13">
									<div class="fil_content">< input class="radio" name="radio" type="radio" value="titan"/>titan</div>
									<div class="fil_content">< input class="radio" name="radio" type="radio" value="fossil"/>fossil</div>
							</div>
						</div>
					</div>
