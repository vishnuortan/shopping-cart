 ...
 export default class Samsung extends React.Component{
		constructor(props){
			super(props);
			this.state={
				list:store.getState().samsung,
				copy:store.getState().samsung
			}
		}
		cart=(e)=>{
		...
		loop=()=>{
			...
			<div class="itemlist">
				<div class="wrapperlist">
					<div class="imagelist2"><img  src={this.state.list[i].img} id="offer1"/></div>
